...
const services = [
  ...
  },
  {
    ...
    desc: "Layanan dedicated untuk klien institusi, koperasi, dan dana pensun dengan fokus pada eksekusi dan riset.",
  },
];

export default function Services() {
  return (
    <section id="services" className="relative py-32 bg-[#0f0f0a]">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-20">
        ...
        <h2 className="font-serif text-3xl md:text-4xl text-[#f5f0e8] mb-16 max-w-xl">
          Solusi Investasi yang{" "}
          <span className="text-gold-gradient">Komprehensif</span>
        </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {services.map((s, i) => (
            <div
              key={i}
              className="card-luxury p-8 md:p-10 group cursor-default"
            >
              <div className="text-[#c9a84c]/60 group-hover:text-[#c9a84c] transition-colors duration-500 mb-6">
                {s.icon}
              </div>
