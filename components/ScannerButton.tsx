...
export function ScannerButton({ onResults, onLoading }: Props) {
  ...
  return (
    <div className="flex items-center gap-3">
      <button onClick={runScan} disabled={loading} className="px-6 py-3 bg-[#3f9e74] text-[#0a0b0b] text-sm font-semibold hover:bg-[#D4B76A] transition-all duration-300 disabled:opacity-40 disabled:cursor-not-allowed border border-[#3f9e74]">
        {loading ? (
