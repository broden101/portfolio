      ...
      <article className="max-w-3xl mx-auto px-6 lg:px-12">
        ...
        <header className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-[#3f9e74] text-xs tracking-wider">June 2026</span>
            <span className="w-1 h-1 rounded-full bg-[#242929]" />
            <span className="text-[#9ba3a6]/50 text-xs tracking-wider uppercase">Robotics / Supply Chain</span>
          </div>
        ...
        <div className="mb-12">
          <div className="card-luxury p-4 md:p-6">
            <Image
              ...
              priority
            />
            <p className="text-[#9ba3a6]/50 text-xs mt-3 text-center italic">
        ...
        <div className="space-y-8 text-[#9ba3a6] text-base leading-relaxed font-light">
          ...
          <h2 className="font-heading text-2xl text-[#edf1f2] font-medium pt-4">The Anatomy of a Robot Joint</h2>
          ...
          <p>
            The infographic above, originally published by <strong className="text-[#edf1f2]">Core Matter</strong>, breaks down the actuator into its five critical subcomponents and maps the key manufacturers behind each one.
          </p>

          <h2 className="font-heading text-2xl text-[#edf1f2] font-medium pt-4">Five Critical Components, Five Different Supply Chains</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="card-luxury p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-heading text-lg text-[#edf1f2] font-medium">Encoders</h3>
              </div>
            ...
            <div className="card-luxury p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-heading text-lg text-[#edf1f2] font-medium">Frameless BLDC Motors</h3>
              </div>
              <p className="text-sm mb-3">
            ...
            <div className="card-luxury p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-heading text-lg text-[#edf1f2] font-medium">Rare-Earth Magnets</h3>
              </div>
              <p className="text-sm mb-3">
            ...
            <div className="card-luxury p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-heading text-lg text-[#edf1f2] font-medium">Planetary Gears</h3>
              </div>
              <p className="text-sm mb-3">
              ...
              <p className="text-xs text-[#9ba3a6]/50 mt-3 italic">
            ...
            <div className="card-luxury p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-heading text-lg text-[#edf1f2] font-medium">Bearings</h3>
              </div>
              <p className="text-sm mb-3">
          ...
          <h2 className="font-heading text-2xl text-[#edf1f2] font-medium pt-4">Geographic Dominance Map</h2>

          <div className="card-luxury p-6 space-y-4">
            <div className="flex items-start gap-3">
              <div className="w-1.5 h-1.5 rounded-full bg-[#3f9e74] mt-2 flex-shrink-0" />
              <div>
                <strong className="text-[#edf1f2]">Germany</strong> — The largest concentration of actuator suppliers: encoders (Heidenhain), motors (TQ-RoboDrive), gears (Neugart, Wittenstein), magnets (Vacuumschmelze), bearings (Schaeffler). A single point of failure if supply is disrupted.
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-1.5 h-1.5 rounded-full bg-[#3f9e74] mt-2 flex-shrink-0" />
              <div>
                <strong className="text-[#edf1f2]">Japan</strong> — Dominates in magnets (Shin-Etsu, TDK) and bearings (NSK, NTN). Also strong in encoders via optical technology.
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-1.5 h-1.5 rounded-full bg-[#3f9e74] mt-2 flex-shrink-0" />
              <div>
                <strong className="text-[#edf1f2]">China</strong> — Rapidly emerging across all categories. Already controls rare-earth magnet supply. Chinese motor and gear manufacturers (CubeMars, Newstart) are gaining market share through competitive pricing.
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-1.5 h-1.5 rounded-full bg-[#3f9e74] mt-2 flex-shrink-0" />
              <div>
                <strong className="text-[#edf1f2]">US / UK / Switzerland / Sweden / Taiwan / Austria</strong> — Each provides specialized pieces. The US contributes motors (Kollmorgen) and encoders (Celera Motion), while Switzerland leads in precision motors (maxon).
              </div>
            </div>
          </div>

          <h2 className="font-heading text-2xl text-[#edf1f2] font-medium pt-4">Investment Implications</h2>

          <p>
            The robotics supply chain presents a unique investment opportunity: <strong className="text-[#edf1f2]">picks-and-shovels plays</strong> benefit regardless of which robot OEM wins the humanoid race.
          </p>
          ...
          <div className="card-luxury p-6 space-y-4">
            <div className="flex items-start gap-3">
              <div className="w-1.5 h-1.5 rounded-full bg-[#3f9e74] mt-2 flex-shrink-0" />
              <div>
                <strong className="text-[#edf1f2]">Component suppliers have pricing power</strong> — Encoders, precision gears, and rare-earth magnets are bottleneck components with few alternatives. Suppliers can pass through cost increases.
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-1.5 h-1.5 rounded-full bg-[#3f9e74] mt-2 flex-shrink-0" />
              <div>
                <strong className="text-[#edf1f2]">China rare-earth dominance is a geopolitical risk</strong> — Any export restriction on neodymium magnets would paralyze global robot production. Investors should monitor PBoC rare-earth policy closely.
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-1.5 h-1.5 rounded-full bg-[#3f9e74] mt-2 flex-shrink-0" />
              <div>
                <strong className="text-[#edf1f2]">German Mittelstand is undervalued</strong> — Many actuator component suppliers are mid-cap German firms (Neugart, Wittenstein, Vacuumschmelze) not yet pricing in the humanoid robot demand wave.
              </div>
            </div>
          </div>
