      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-3">
            ...
            <span className="text-[#3f9e74] text-xs tracking-[0.3em] uppercase font-medium">Simulation</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
          {/* Modal Awal */}
          <div>
            <label className="block text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase mb-2">Modal Awal (Rp)</label>
            <input
              type="number"
              value={modal}
              onChange={(e) => setModal(e.target.value)}
              className="w-full bg-[#1A1A18] border border-[#242929] text-[#edf1f2] px-4 py-3 text-sm font-mono focus:outline-none focus:border-[#3f9e74]/50 transition-colors"
          ...
          {/* Start Year */}
          <div>
            <label className="block text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase mb-2">Backtest Start Year</label>
            <select
              value={startYear}
              onChange={(e) => setStartYear(parseInt(e.target.value))}
              className="w-full bg-[#1A1A18] border border-[#242929] text-[#edf1f2] px-4 py-3 text-sm font-mono focus:outline-none focus:border-[#3f9e74]/50 transition-colors cursor-pointer appearance-none"
            >
              {START_YEARS.map((y) => (
          ...
          {/* Forecast Period */}
          <div>
            <label className="block text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase mb-2">Forecast Period</label>
            <select
          ...
          <div className="flex items-end">
            <button
              ...
              disabled={loading}
              className="w-full bg-[#3f9e74] text-[#0a0b0b] px-6 py-3 text-sm tracking-[0.15em] uppercase font-semibold hover:bg-[#3f9e74] transition-colors disabled:opacity-50"
            >
        ...
        <div className="mb-10">
          <label className="block text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase mb-2">Pilih Saham</label>
          ...
          <div className="flex flex-wrap gap-2 mb-3">
            {selectedTickers.map((t) => (
              <span
                key={t}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#3f9e74]/10 border border-[#3f9e74]/30 text-[#3f9e74] text-[11px] font-mono cursor-pointer hover:bg-[#3f9e74]/20 transition-colors"
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-[#1A1A18] border border-[#242929] text-[#9ba3a6]/70 px-4 py-2.5 text-sm focus:outline-none focus:border-[#3f9e74]/50 transition-colors"
            />
            {showDropdown && (
              <div
                className="absolute top-full left-0 right-0 z-50 bg-[#1A1A18] border border-[#242929] max-h-[240px] overflow-y-auto"
                onMouseLeave={() => setShowDropdown(false)}
              >
                <div className="p-1.5 text-[#9ba3a6]/30 text-[9px] tracking-[0.1em] uppercase px-2">IDX100</div>
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 text-sm font-mono transition-colors flex items-center gap-3 ${
                        selected
                          ? "text-[#3f9e74] bg-[#3f9e74]/10"
                          : "text-[#9ba3a6]/60 hover:text-[#9ba3a6] hover:bg-[#242929]/50"
                      }`}
                    >
                      <span className={`w-3.5 h-3.5 border flex items-center justify-center ${
                        selected ? "border-[#3f9e74] bg-[#3f9e74]" : "border-[#242929]"
                      }`}>
                        {selected && (
                          <svg width="8" height="8" viewBox="0 0 8 8" fill="none" stroke="#0a0b0b" strokeWidth="2">
        ...
        {backtestData && (
          <div className="mb-14">
            <h2 className="font-heading text-xl text-[#edf1f2] font-medium mb-6 flex items-center gap-3">
                ...
                return (
                  <>
                    <div className="card-luxury p-5">
                      <div className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase mb-1">Total Investasi</div>
                      <div className="font-heading text-2xl text-[#edf1f2] font-medium">{fmtRp(totalInvest)}</div>
                    </div>
                    <div className="card-luxury p-5">
                      <div className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase mb-1">Nilai Akhir</div>
                      <div className={`font-heading text-2xl font-medium ${totalFinal >= totalInvest ? "text-emerald-400" : "text-red-400"}`}>
                        {fmtRp(totalFinal)}
                      </div>
                    </div>
                    <div className="card-luxury p-5">
                      <div className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase mb-1">Rata-Rata Return</div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-[#242929]">
                    <th className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase font-normal pb-3 pr-4">Saham</th>
                    <th className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase font-normal pb-3 pr-4">Harga</th>
                    <th className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase font-normal pb-3 pr-4">Modal</th>
                    <th className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase font-normal pb-3 pr-4">Final</th>
                    <th className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase font-normal pb-3 pr-4">Return %</th>
                    <th className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase font-normal pb-3 pr-4">CAGR</th>
                    <th className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase font-normal pb-3 pr-4">Capital Gain</th>
                    <th className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase font-normal pb-3">Dividen</th>
                  </tr>
                </thead>
                <tbody>
                  {backtestData.map((r) => (
                    <tr key={r.ticker} className="border-b border-[#1A1A18] hover:bg-[#1A1A18]/50 transition-colors">
                      <td className="py-3 pr-4">
                        <span className="text-[#edf1f2] font-mono text-sm font-medium">{r.ticker}</span>
                        <span className="text-[#9ba3a6]/40 text-[10px] block">{r.name?.slice(0, 35)}</span>
                      </td>
                      <td className="py-3 pr-4 text-[#edf1f2] font-mono text-sm">{fmtPrice(r.currentPrice)}</td>
                      <td className="py-3 pr-4 text-[#edf1f2] font-mono text-sm">{fmtRp(parseFloat(modal))}</td>
                      ...
                      <td className="py-3 font-mono text-sm text-[#9ba3a6]/70">
        ...
        {forecastData && (
          <div className="mb-14">
              ...
              {(() => {
                ...
                return (
                  <>
                    ...
                    <div className="card-luxury p-5">
                      <div className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase mb-1">Proyeksi Nilai</div>
                      <div className={`font-heading text-2xl font-medium ${totalProj >= totalInvest ? "text-emerald-400" : "text-red-400"}`}>
                        {fmtRp(totalProj)}
                      </div>
                    </div>
                    <div className="card-luxury p-5">
                      <div className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase mb-1">Modal + Dividen</div>
                      <div className="font-heading text-2xl text-[#9ba3a6]/70 font-medium">
                        {fmtRp(totalProj)}
                      </div>
                    </div>
                  </>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-[#242929]">
                    ...
                    <th className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase font-normal pb-3 pr-4">Harga</th>
                    <th className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase font-normal pb-3 pr-4">Modal</th>
                    <th className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase font-normal pb-3 pr-4">Proyeksi</th>
                    <th className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase font-normal pb-3 pr-4">Capital Gain</th>
                    <th className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase font-normal pb-3 pr-4">Dividen Kumulatif</th>
                    <th className="text-[#9ba3a6]/50 text-[10px] tracking-[0.15em] uppercase font-normal pb-3">Div.Yield/th</th>
                  </tr>
                </thead>
                <tbody>
                  {forecastData.map((r) => (
                    <tr key={r.ticker} className="border-b border-[#1A1A18] hover:bg-[#1A1A18]/50 transition-colors">
                      ...
                      <td className="py-3 pr-4 font-mono text-sm text-[#9ba3a6]/70">
            ...
            <div className="mt-4 p-4 border border-[#242929] bg-[#1A1A18]/30">
              <p className="text-[#9ba3a6]/50 text-[10px] tracking-[0.1em] leading-relaxed">
